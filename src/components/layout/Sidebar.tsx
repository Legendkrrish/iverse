...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 flex flex-col h-screen glass border-r z-20 sticky top-0">
            ...
            <Link key={item.name} href={item.href} passHref>
              <Button
                ...
                className={cn(
                  ...
                  isActive ? "bg-primary/10 text-primary font-medium" : "text-muted-foreground hover:bg-black/5 dark:hover:bg-white/5"
                )}
              >
